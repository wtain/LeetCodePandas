...
# Details
# 425ms
# Beats 10.84%of users with Pandas
# Memory
# Details
# 62.01MB
# Beats 6.26%of users with Pandas
def actors_and_directors(actor_director: pd.DataFrame) -> pd.DataFrame:
    cooperations = actor_director\
        .groupby(by=['actor_id', 'director_id'])\
        .count()\
        .reset_index()\
        .rename(columns={'timestamp': 'count'})
    return cooperations[cooperations['count'] >= 3][['actor_id', 'director_id']]
