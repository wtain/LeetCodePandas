...
# Details
# 466ms
# Beats 15.32%of users with Pandas
# Memory
# Details
# 62.16MB
# Beats 57.00%of users with Pandas
# https://leetcode.com/problems/group-sold-products-by-the-date/solutions/3946871/pandas-my-approach-with-clear-comments/?envType=study-plan-v2&envId=30-days-of-pandas&lang=pythondata
def categorize_products(activities: pd.DataFrame) -> pd.DataFrame:
    ...
    return grouped.sort_values(by='sell_date')
